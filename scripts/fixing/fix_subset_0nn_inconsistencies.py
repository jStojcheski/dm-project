...
if __name__ == '__main__':
    ...
    subset_0nn = pd.read_csv('../../data/subsets/PerformanceEvaluation/0_n_n.tsv', sep='\t')
    ...
    df_inconsistencies = subset_0nn[~np.isnan(subset_0nn.SAPECoeficient)]
    ...
    df_fixed.to_csv(path_or_buf='../../data/dataset/Spenser_1_7_1_fixed_0nn_inconsistencies.tsv', sep='\t', index=None)
